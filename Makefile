...
HTTPS_GIT      := https://github.com/ojo-network/ojo-chainibc-demo.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=oracledemo \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=oracledemo \
